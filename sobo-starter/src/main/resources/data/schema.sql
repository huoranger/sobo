...
-- ----------------------------
-- Table structure for sobo_article_type
-- ----------------------------
DROP TABLE IF EXISTS `sobo_article_type`;
CREATE TABLE `sobo_article_type` (
...
-- ----------------------------
-- Table structure for sobo_cache
-- ----------------------------
DROP TABLE IF EXISTS `sobo_cache`;
CREATE TABLE `sobo_cache` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_comment
-- ----------------------------
DROP TABLE IF EXISTS `sobo_comment`;
CREATE TABLE `sobo_comment` (
...
-- ----------------------------
-- Table structure for sobo_message
-- ----------------------------
DROP TABLE IF EXISTS `sobo_message`;
CREATE TABLE `sobo_message` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_opt_log
-- ----------------------------
DROP TABLE IF EXISTS `sobo_opt_log`;
CREATE TABLE `sobo_opt_log` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_posts
-- ----------------------------
DROP TABLE IF EXISTS `sobo_posts`;
CREATE TABLE `sobo_posts` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `audit_state` varchar(64) NOT NULL COMMENT '审核状态',
...
-- ----------------------------
-- Table structure for sobo_search
-- ----------------------------
DROP TABLE IF EXISTS `sobo_search`;
CREATE TABLE `sobo_search` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_tag
-- ----------------------------
DROP TABLE IF EXISTS `sobo_tag`;
CREATE TABLE `sobo_tag` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `audit_state` varchar(64) NOT NULL COMMENT '审核状态',
...
-- ----------------------------
-- Table structure for sobo_tag_posts_mapping
-- ----------------------------
DROP TABLE IF EXISTS `sobo_tag_posts_mapping`;
CREATE TABLE `sobo_tag_posts_mapping` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_user
-- ----------------------------
DROP TABLE IF EXISTS `sobo_user`;
CREATE TABLE `sobo_user` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_user_follow
-- ----------------------------
DROP TABLE IF EXISTS `sobo_user_follow`;
CREATE TABLE `sobo_user_follow` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_user_food
-- ----------------------------
DROP TABLE IF EXISTS `sobo_user_food`;
CREATE TABLE `sobo_user_food` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
...
-- ----------------------------
-- Table structure for sobo_config
-- ----------------------------
DROP TABLE IF EXISTS `sobo_config`;
CREATE TABLE `sobo_config` (
  `id` bigint(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `state` varchar(64) NOT NULL COMMENT '状态',
  `type` varchar(64) NOT NULL COMMENT '类型',
...
ALTER TABLE sobo_user ADD `source` varchar(64) default 'REGISTER' COMMENT '来源' AFTER `sex`;
ALTER TABLE sobo_user ADD `ext` blob COMMENT '扩展信息' AFTER `signature`;
